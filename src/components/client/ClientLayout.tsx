...
import { 
  LayoutDashboard, FolderOpen, Plus, FileText, GitCompare,
  TrendingUp, CheckSquare, AlertTriangle, RefreshCw,
  Folder, CreditCard, Bell, MessageSquare, User,
  ...
  const menuItems = [
    {
      category: 'PROJECTS',
      items: [
        { icon: FolderOpen, label: 'My Projects', path: '/client/projects' },
        { icon: Plus, label: 'Post a Project', path: '/client/projects/new' },
        { icon: FileText, label: 'Bids Received', path: '/client/bids' },
        { icon: GitCompare, label: 'Compare Bids', path: '/client/compare' },
      ]
    },
    {
      ...
      items: [
        ...
        { icon: AlertTriangle, label: 'QA & Inspections', path: '/client/qa' },
        { icon: AlertTriangle, label: 'Quality Issues', path: '/client/quality-issues' },
        { icon: RefreshCw, label: 'Corrective Actions', path: '/client/corrective-actions' },
        { icon: RefreshCw, label: 'Reinspection', path: '/client/reinspection' },
    ...
    },
    {
      category: 'SERVICES',
      items: [
        { icon: Users, label: 'Architect / Engineer', path: '/client/architect-services' },
        { icon: DollarSign, label: 'Construction Finance', path: '/client/finance' },
      ]
    },
    {
      category: 'ACCOUNT',
