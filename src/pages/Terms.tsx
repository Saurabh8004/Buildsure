        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="space-y-8 text-navy-light/80 text-sm leading-relaxed">
            ...
            <div>
              ...
              <p>You must provide accurate information when creating an account. You are responsible for maintaining the security of your account credentials. Professional users must provide verifiable credentials and documents.</p>
            </div>

            <div>
              <h2 className="text-lg font-bold text-navy mb-3">4. Platform Usage</h2>
              <p>Users agree to:</p>
              <ul className="list-disc pl-5 mt-2 space-y-1">
                <li>Provide accurate project requirements and bid information</li>
                <li>Not misuse the platform or attempt to circumvent verification processes</li>
