    ...
    <div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-4">
              ...
              <Link to="/financing" className="inline-flex items-center justify-center gap-2 px-6 py-3.5 text-base font-semibold text-navy border-2 border-navy hover:bg-navy hover:text-white rounded-xl transition-all">
                Explore Financing
              </Link>
            </div>
      ...
      <section className="py-16 lg:py-24 bg-grey-light border-y border-border-light">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-2xl sm:text-3xl font-bold text-navy tracking-tight">See What Opportunities Look Like</h2>
              <p className="mt-4 text-navy-light/70 leading-relaxed">
                Projects on BuildSure come with structured requirements — clear scope, budget range, timeline and location. You can quickly assess if a project matches your capabilities.
              </p>
              <div className="mt-6 space-y-3">
                {['Clear project scope and specifications', 'Budget range and timeline provided', 'Location and service area matching', 'Bid deadline clearly stated', 'Structured bid submission process'].map((item, i) => (
            ...
            <div className="bg-white rounded-2xl p-6 border border-border-light shadow-sm">
              <div className="flex items-center justify-between mb-4">
                <span className="text-xs font-semibold text-orange bg-orange/10 px-2 py-1 rounded">DEMO OPPORTUNITY</span>
              ...
              <div className="mt-4 grid grid-cols-2 gap-3">
                <div className="bg-grey-light rounded-lg p-3">
      ...
      <section className="py-16 lg:py-24 bg-navy">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-2xl sm:text-3xl font-bold text-white tracking-tight">Need Funds to Execute More Projects?</h2>
