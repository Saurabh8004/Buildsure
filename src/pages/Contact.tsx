...
export default function Contact() {
  ...
  const [form, setForm] = useState({
    name: '', email: '', mobile: '', role: '', subject: '', message: ''
  });
  ...
  if (submitted) {
    return (
      <div className="min-h-[60vh] flex items-center justify-center bg-slate-warm">
        <div className="text-center max-w-md mx-auto px-4">
          ...
          <button
            ...
            className="mt-6 px-6 py-2.5 text-sm font-semibold text-teal border border-teal rounded-lg hover:bg-teal hover:text-white transition-colors"
          >
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <textarea
                ...
                value={form.message}
                onChange={handleChange}
                className="w-full px-4 py-3 border border-border-light rounded-xl text-sm text-navy focus:outline-none focus:ring-2 focus:ring-teal/30 focus:border-teal transition-colors resize-none"
            ...
            <button
              type="submit"
              className="w-full sm:w-auto px-8 py-3.5 text-base font-semibold text-white bg-teal hover:bg-teal-dark rounded-xl transition-all shadow-lg shadow-teal/20"
            >
              Send Message
            </button>
          </form>
