  ...
  return (
    <div className="p-6 lg:p-8">
      ...
      >
        ...
        <p className="text-text-muted mt-1">View corrective actions taken for quality issues</p>
      </motion.div>
      ...
      >
        ...
        <h3 className="text-xl font-bold text-navy mb-2">No corrective actions</h3>
