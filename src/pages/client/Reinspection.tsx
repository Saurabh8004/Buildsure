  ...
  return (
    <div className="p-6 lg:p-8">
      ...
      >
        ...
        <p className="text-text-muted mt-1">Track reinspection results and status</p>
      </motion.div>
      ...
      >
        ...
        <h3 className="text-xl font-bold text-navy mb-2">No reinspections</h3>
        <p className="text-text-muted">
          Reinspection results will appear here when scheduled
        </p>
      </motion.div>
    </div>
  );
