    ...
    <div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-grey-light rounded-2xl p-8 border border-border-light">
              ...
              <p className="text-navy-light/70 leading-relaxed">Make construction procurement and project delivery more transparent, competitive and quality-focused.</p>
            </div>
            <div className="bg-grey-light rounded-2xl p-8 border border-border-light">
              ...
              <p className="text-navy-light/70 leading-relaxed">Build a trusted digital ecosystem connecting property owners, contractors and construction professionals.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-3 text-navy-light/70 max-w-xl mx-auto">We're building BuildSure with local construction requirements, contractors and professionals in mind — starting with Lucknow, India.</p>
          <div className="mt-8">
