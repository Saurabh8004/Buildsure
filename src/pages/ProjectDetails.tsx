...
import { ArrowLeft, MapPin, Calendar, FileText, Users, CheckCircle, Clock, Building2 } from 'lucide-react';
...
export default function ProjectDetails() {
  ...
  const [architectRequests, setArchitectRequests] = useState<any[]>([]);
  ...
  async function loadProjectData() {
    ...
    try {
      ...
      // Load architect service requests for this project
      if (user) {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {tenders.length === 0 && (
          <motion.div
            ...
            className="bg-white rounded-2xl border border-border p-12 text-center mt-6"
          >
